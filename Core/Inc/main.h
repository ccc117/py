...
#define CAM_RCLK_Pin GPIO_PIN_9
#define CAM_RCLK_GPIO_Port GPIOG
#define CAM_RRST_Pin GPIO_PIN_11
#define CAM_RRST_GPIO_Port GPIOG
...
#define VS_RST_Pin GPIO_PIN_8
#define VS_RST_GPIO_Port GPIOB
#define VS_DREQ_Pin GPIO_PIN_9
